...
The public deployment runs separate Nginx web and restricted Node API containers. See [Synology DSM deployment](./docs/SYNOLOGY-DEPLOYMENT.md) for reverse proxy, HTTPS, allowlist, and security instructions.
