...
export const GridModeView: React.FC<GridModeViewProps> = ({ nodes, settings, onCreateTask, onDeleteNode, onMaximize, gridState, onStateChange }) => {
    ...
    const isMinimax = currentProvider?.type === 'minimax' || modelId === 'MiniMax-H3';
    const resolutionOptions = isMinimax ? ['768P', '2K'] : ['720p', '1080p'];
    ...
    }, [resolution, isMinimax, providerId, modelId]);
